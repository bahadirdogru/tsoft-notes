...
!function(t) {
    ...
    V.escapeSelector || (e = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g,
    d = function(t, e) {
    ...
    function q(s) {
        ...
        o.length ? ("0,0,0,0" === o.join() && H.extend(o, st.transparent),
        n) : st[s]
    }
    function K(t, e, i) {
    ...
    (E.fn = H.extend(E.prototype, {
        parse: function(n, t, e, i) {
            if (void 0 === n)
                ...
                this;
            (n.jquery || n.nodeType) && (n = H(n).css(t),
            t = void 0);
            var o = this
              , s = B(n)
              , a = this._rgba = [];
    ...
    (E.hook = function(t) {
        ...
        Y(t, function(t, o) {
            ...
            H.fx.step[o] = function(t) {
                t.colorInit || (t.start = E(t.elem, o),
                t.end = E(t.end),
                t.colorInit = !0),
        ...
        return this.queue(function() {
            ...
            e = e.map(function() {
                ...
                this.diff = function(t, e) {
                    ...
                    for (i in e)
                        s = e[i],
                        t[i] !== s && (Q[i] || !V.fx.step[i] && isNaN(parseFloat(s)) || (n[i] = s));
                    return n
                }(this.start, this.end),
                this
            }),
    ...
    V.fn.extend({
        ...
        removeClass: (X = V.fn.removeClass,
        function(t, e, i, s) {
        ...
        toggleClass: (U = V.fn.toggleClass,
        function(t, e, i, s, n) {
